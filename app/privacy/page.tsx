        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <p>
              ...
              and safeguard your information when you use our university program matching platform.
            </p>
            <p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6">
              ...
              <li>
                <strong>Communication:</strong> To send you magic link emails for authentication and
          ...
          <section>
            ...
            <ul className="list-disc pl-6">
              <li>
                <strong>Contract Performance:</strong> Processing necessary to provide our matching
                services to you
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6">
              <li>
                <strong>Google (Authentication):</strong> For Google Sign-In functionality. Subject
                to{' '}
                <a
              ...
              <li>
                <strong>Algolia (Search):</strong> Program search functionality. Data is anonymized.
                Subject to{' '}
                <a
            ...
            <p className="mt-4">
              We do not sell your personal data to third parties. We do not share your academic data
              with universities unless you explicitly request it.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6">
              <li>
                <strong>Essential Cookies:</strong> Required for authentication and security. These
                cannot be disabled.
              </li>
            </ul>
            <p className="mt-4">
          ...
          <section>
            ...
            <p>
              IB Match is intended for IB students typically aged 16-19. We do not knowingly collect
              personal data from children under 13. If you are under 16, please obtain parental
          ...
          <section>
            ...
            <p>
              ...
              updated&quot; date. Continued use of IB Match after changes constitutes acceptance of
              the updated policy.
            </p>
          </section>
