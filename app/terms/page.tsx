      ...
      <div className="mx-auto max-w-3xl py-12">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <p>
              The Service may display information about universities and programs sourced from third
              parties. We make reasonable efforts to ensure accuracy but:
            </p>
            <ul className="list-disc pl-6">
              <li>
          ...
          <section>
            ...
            <p>
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, IB MATCH SHALL NOT BE LIABLE FOR ANY INDIRECT,
          ...
          <section>
            ...
            <p>
              ...
              jurisdiction in which IB Match operates, without regard to conflict of law provisions.
            </p>
            <p className="mt-4">
