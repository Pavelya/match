              ...
              <tr>
                {Array.from({ length: columns }).map((_, colIndex) => (
                  <th key={colIndex} className="px-4 py-3">
                    <div
                      className="h-4 rounded skeleton-bg animate-pulse"
                  ...
                  <td key={colIndex} className="px-4 py-3">
                    {colIndex === 0 ? (
                      ...
                      <div className="flex items-center gap-3">
                        <div className="h-9 w-9 rounded-full skeleton-bg animate-pulse" />
                        <div className="space-y-2">
                          <div className="h-4 w-24 rounded skeleton-bg animate-pulse" />
                          <div className="h-3 w-32 rounded skeleton-bg animate-pulse" />
                        </div>
                      </div>
                    ) : colIndex === columns - 1 ? (
                      // Last column often has action
                      <div className="h-4 w-12 rounded skeleton-bg animate-pulse ml-auto" />
                    ) : (
  ...
  return (
    <div className={cn('mb-6', className)}>
      ...
      <div className="flex gap-3">
        ...
        <div className="flex-1 h-12 rounded-xl skeleton-bg animate-pulse" />
        {/* Filter toggle button skeleton */}
        <div className="w-12 h-12 rounded-xl skeleton-bg animate-pulse" />
      </div>
    </div>
  )
}
