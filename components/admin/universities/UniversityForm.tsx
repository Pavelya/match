/**
 * University Form Component (Create)
 *
 * Client component for creating new universities.
 * Features:
 * - Name, abbreviated name, description fields
 * - Country selector, city field
 * - Classification (PUBLIC/PRIVATE) selection
 * - Logo and campus image file uploads (500KB max each)
 * - Optional fields: student population, contact info
...
export function UniversityForm({ countries }: UniversityFormProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    countryId: '',
    city: '',
    classification: 'PUBLIC' as 'PUBLIC' | 'PRIVATE',
    studentPopulation: '',
    logo: '',
    image: '',
    websiteUrl: '',
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Success - redirect to universities list
